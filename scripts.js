// Mapping of network names to their corresponding IDs
const network_ids = {
    "MTN": 1,
    "AIRTEL": 4,
    "GLO": 2,
...
// Function to get network ID from network name
function getNetworkId(networkName) {
    return network_ids[networkName] || null;  // Return null if network name is not found
}
